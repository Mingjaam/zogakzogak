...
const ElderlyProfileScreen: React.FC = () => {
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-grow">
                        <h3 className="text-lg font-bold text-gray-800">박길수</h3>
                        <p className="text-sm text-gray-600">grandpa@family.com</p>
                        <p className="text-sm text-blue-600 font-medium mt-1">어르신 계정</p>
                    </div>
